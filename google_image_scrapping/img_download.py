...
def search_and_download(search_term:str,driver_path:str,target_path=r'C:\Users\Vishwas\Desktop\Techno Ramdev\images_dataset\vrikshasana',number_images=5):
    target_folder = os.path.join(target_path,'_'.join(search_term.lower().split(' ')))
